...
TP = len(filter(lambda tuple: tuple[0] and tuple[1], zipped))
print("TP count is %d" % TP)
TN = len(filter(lambda tuple: tuple[0] == 0 and tuple[1] == 0, zipped))
print("TN count is %d" % TN)
FP = len(filter(lambda tuple: tuple[0] == 0 and tuple[1] == 1, zipped))
print("FP count is %d" % FP)
FN = len(filter(lambda tuple: tuple[0] == 1 and tuple[1] == 0, zipped))
print("FN count is %d" % FN)
